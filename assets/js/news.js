/* ============================================================
   ...
   news-es.json (Spanish), working both in:
   - root pages
   - /es/ pages
   - GitHub Pages repo paths like /stragta/

   Spanish page:
   <script src="../assets/js/news.js" data-lang="es"></script>

   English/root page:
   <script src="./assets/js/news.js" data-lang="en"></script>
   ============================================================ */
  ...
  en: [
    {
      id: 'demo-1',
      date: '2026-03-21',
      headline: 'McKinsey: 72% of enterprises now use AI in at least one business function',
      summary: 'The latest McKinsey Global Survey reveals accelerating AI adoption, with generative AI leading in marketing, software development, and operations. Successful implementations remain concentrated among a guided minority.',
    ...
    },
    {
      id: 'demo-2',
      date: '2026-03-20',
      headline: 'EU AI Act enforcement: what business leaders need to do now',
      summary: 'With the EU AI Act entering its compliance phase, enterprises face new obligations around documentation, human oversight, and staff training before year-end deadlines.',
    ...
    },
    {
      id: 'demo-3',
      date: '2026-03-19',
      headline: 'Why enterprise AI implementations fail at year two',
      summary: 'A Stanford study tracking 180 enterprise AI deployments found companies bypassing structured guidance saw a 3.2x higher failure rate, driven by change management gaps rather than technical problems.',
      source: 'Stanford HAI',
  ...
  es: [
    {
      id: 'demo-es-1',
      date: '2026-03-21',
      headline: 'El 72% de las empresas ya usa inteligencia artificial en al menos una función de negocio',
      summary: 'La última encuesta global de McKinsey revela una aceleración en la adopción de IA, con la IA generativa liderando en marketing, desarrollo de software y operaciones. Las implementaciones exitosas siguen concentradas entre una minoría con guía especializada.',
      source: 'McKinsey Global Institute',
      sourceUrl: 'https://mckinsey.com',
      imageUrl: '',
    ...
    },
    {
      id: 'demo-es-2',
      date: '2026-03-20',
      headline: 'Reglamento de IA de la UE en fase de cumplimiento: lo que los directivos necesitan hacer ahora',
      summary: 'Con el Reglamento de IA de la UE en vigor, las empresas europeas deben cumplir nuevas obligaciones de documentación, supervisión humana y formación del personal antes de fin de año.',
    ...
    },
    {
      id: 'demo-es-3',
      date: '2026-03-19',
      headline: 'Por qué fracasan las implementaciones de IA empresarial en el segundo año',
      summary: 'Un estudio de Stanford que rastreó 180 implementaciones de IA empresarial encontró que las empresas que prescindieron de orientación estructurada tuvieron una tasa de fracaso 3,2 veces mayor, impulsada por brechas en la gestión del cambio.',
      source: 'Stanford HAI',
      sourceUrl: 'https://hai.stanford.edu',
      imageUrl: '',
...
function detectLang() {
  const script = document.currentScript || document.querySelector('script[src*="news.js"]');
...
function getBasePath() {
  ...
  const idx = scriptUrl.pathname.indexOf(marker);

  if (idx === -1) return '';
  return scriptUrl.pathname.slice(0, idx);
}
...
async function loadNews() {
  ...
  const fileName = lang === 'es' ? 'news-es.json' : 'news.json';
  const file = `${basePath}/${fileName}?t=${Date.now()}`;
